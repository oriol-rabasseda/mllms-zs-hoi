...
gerunds = {'carry': 'carrying',
           ...
           'stand': 'standing',
           'surf': 'surfing',
           'talk_on_phone': 'talking on phone',
           'throw': 'throwing',
           'walk': 'walking',
           'work_on_computer': 'working on computer'}
...
for vcoco in vcoco_all:
    for i in range(len(vcoco['image_id'])):
        ...
        if obj == '' and instr == '':
            question = f"Is there anybody {hoi['action_gerund']}? Answer with yes or no."
        elif obj == '':
            question = f"Is there anybody {hoi['action_gerund']} with a {hoi['instr']}? Answer with yes or no."
        elif instr == '':
            question = f"Is there anybody {hoi['action_gerund']} a {hoi['obj']}? Answer with yes or no."
        else:
            question = f"Is there anybody {hoi['action_gerund']} a {hoi['obj']} with a {hoi['instr']}? Answer with yes or no."
...
with open("annotations/questions_per_hoi.json", 'w') as f:
