...
for vcoco in vcoco_all:
    for i in range(len(vcoco['image_id'])):
        ...
        if obj == '' and instr == '':
            question = f"Is the person in the blue box {hoi['action_gerund']}? Answer yes or no."
        elif obj == '':
            question = f"Is the person in the blue box {hoi['action_gerund']} with the {hoi['instr']} in the green box? Answer with yes or no."
        elif instr == '':
            question = f"Is the person in the blue box {hoi['action_gerund']} the {hoi['obj']} in the red box? Answer with yes or no."
        else:
            question = f"Is the person in the blue box {hoi['action_gerund']} the {hoi['obj']} in the red box with the {hoi['instr']} in the green box? Answer with yes or no."
...
with open("annotations/questions_per_hoi_bbox.json", 'w') as f:
