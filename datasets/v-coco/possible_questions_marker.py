...
for vcoco in vcoco_all:
    for i in range(len(vcoco['image_id'])):
        ...
        if obj == '' and instr == '':
            question = f"Is the person within the blue marker {hoi['action_gerund']}? Answer yes or no."
        elif obj == '':
            question = f"Is the person within the blue marker {hoi['action_gerund']} with the {hoi['instr']} within the green marker? Answer with yes or no."
        elif instr == '':
            question = f"Is the person within the blue marker {hoi['action_gerund']} the {hoi['obj']} within the red marker? Answer with yes or no."
        else:
            question = f"Is the person within the blue marker {hoi['action_gerund']} the {hoi['obj']} within the red marker with the {hoi['instr']} within the green marker? Answer with yes or no."
...
with open("annotations/questions_per_hoi_marker.json", 'w') as f:
