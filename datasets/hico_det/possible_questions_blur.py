...
for hoi_id in hoi_info.keys():
    ...
    TEMPLATE = f"Is the foreground person {action_text} a {object_type_text}? Answer yes or no."
...
with open('./annotations/questions_per_hoi_blur.json', "w") as new_jsonl_file:
