...
for hoi_id in hoi_info.keys():
    ...
    TEMPLATE = f"Is the person within the blue marker {action_text} the {object_type_text} within the red marker? Answer yes or no."
...
with open('./annotations/questions_per_hoi_marker.json', "w") as new_jsonl_file:
