...
for hoi_id in hoi_info.keys():
    ...
    TEMPLATE = f"Is the person in the blue box {action_text} the {object_type_text} in the red box? Answer yes or no."
...
with open('./annotations/questions_per_hoi_bbox.json', "w") as new_jsonl_file:
